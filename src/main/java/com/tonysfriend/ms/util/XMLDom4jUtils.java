...
public class XMLDom4jUtils {
     ...
     */
    public static int getAttributeAsInt(Element element, String name,
                                        int defaultValue, boolean optional) throws Exception {
        String value = getAttribute(element, name, optional);
        if ((optional) && ((value == null) || (value.equals("")))) {
            return defaultValue;
        } else {
     ...
     */
    public static float getAttributeAsFloat(Element element, String name,
                                            float defaultValue, boolean optional) throws Exception {
        String value = getAttribute(element, name, optional);
        if ((optional) && ((value == null) || (value.equals("")))) {
            return defaultValue;
        } else {
     ...
     */
    public static long getAttributeAsLong(Element element, String name,
                                          long defaultValue, boolean optional) throws Exception {
        String value = getAttribute(element, name, optional);
        if ((optional) && ((value == null) || (value.equals("")))) {
            return defaultValue;
        } else {
     ...
     *
     * @param xmlSource URL、XML字符串、XML文件名等 Object
...
//
//            System.out.println(element2XML(root, "utf-8"));
//
//        } catch (Exception ex) {
//            ex.printStackTrace();
//        }

        String xmlString = "<instance>\n" +
        ...
        try {
            Document document = XMLDom4jUtils.fromXML(xmlString, "utf-8");
